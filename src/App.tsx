  ...
  return (
    <div>
      ...
      {user && user.role === "cajero" && (
        <PuntoDeVentas onLogout={handleLogout} />
      )}
      ...
      {user && user.role !== "cajero" && user.role !== "admin" && (
        ...
        >
          ...
          <p style={{ color: "#475569" }}>
            Su cuenta tiene rol "{user.role || "sin rol"}". Solo usuarios con
            rol <strong>cajero</strong> pueden acceder al Punto de Ventas.
          </p>
          <div style={{ marginTop: 18 }}>
            <button onClick={handleLogout} className="btn-opaque">
              Cerrar sesión
            </button>
          </div>
        </div>
