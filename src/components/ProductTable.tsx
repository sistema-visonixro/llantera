              ...
              >
                ...
                <td style={{ ...tdStyle, padding: '10px', textAlign: 'center' }}>
                  {(() => {
                    ...
                    const disabled = precioNum <= 0 || (!esServicio && stockNum < 1)
                    const label = disabled ? (precioNum <= 0 ? 'Sin precio' : 'Agotado') : '+ Agregar'
                    return (
                      <button
                        ...
                        title={disabled ? (precioNum <= 0 ? 'El producto no tiene precio válido' : 'No hay stock disponible') : esServicio ? 'Agregar servicio al carrito' : 'Agregar al carrito'}
                        onMouseEnter={(e) => {
                          if (!disabled) {
